...
class ConstraintBuilder(AbstractConstraintBuilder):
    def max_vol(self, max_vol: Union[Iterable[float], float]):
    ...
    def max_cvar(self, max_cvar: Union[Iterable[float], float], percentile=5.0):
    ...
    def min_returns(self, min_ret: Union[Iterable[float], float]):
